...
public class Textos {
	...
	public static final String MENSAJE_SALIR = "¿Realmente desea salir?";
	public static final String LB_DIRECCION = "Dirección";
	public static final String LB_PUERTO = "Puerto";
	public static final String DIRECCION_VACIA = "La dirección está vacía";
	public static final String PUERTO_INVALIDO = "El puerto no es válido";
